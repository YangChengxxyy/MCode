...
fn current_golden_freezes_ids_task_shapes_rejections_and_assigned_errors() {
    ...
    let mut lines = vec![
        ...
        r#"{"rule":"pack-activation","selectionStampPrefix":"psel1","configuredSet":"exact-ordered-executable","maxPackIds":256,"empty":"atomic-deactivate-all","cardinality":["single","multi"],"version":"current-only","runtime":"generation-bound-atomic-activation"}"#.to_owned(),
