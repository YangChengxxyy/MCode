...
use mcode_plugin_api::{
    ...
    MANAGER_LIFECYCLE_INTERFACE_ID, MANAGER_WIT, MANAGER_WIT_PACKAGE, MANAGER_WORLD,
    MANAGER_WORLD_ID, MANAGER_WORLD_VERSION, PROVIDER_INTERFACE, PROVIDER_INTERFACE_ID,
    PROVIDER_WIT_PACKAGE, PROVIDER_WORLD, PROVIDER_WORLD_ID, PROVIDER_WORLD_VERSION,
};
